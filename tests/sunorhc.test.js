...
describe('Methods test', () => {
    ...
    test('"getLocaleDateElement" method', () => {
        ...
        expect(s2.getLocaleDateElement('month', 'long', locale2)).toMatch(/^(M05|May|mai)$/)
        expect(s2.getLocaleDateElement('month', 'short', locale2)).toMatch(/^(M05|May|mai)$/)
        ...
        expect(s1.getLocaleDateElement('weekday', 'long', locale2)).toMatch(/^(Fri(|day)|vendredi)$/)
        expect(s1.getLocaleDateElement('weekday', 'short', locale2)).toMatch(/^(Fri|ven.)$/)
        expect(s1.getLocaleDateElement('weekday', 'narrow', locale2)).toMatch(/^(F|V)$/)
        ...
        expect(s1.getLocaleDateElement('era', {era: 'long'}, locale2)).toMatch(/^(4\s9,\s2021\sAnno\sDomini|9\s4\s2021\saprès\sJésus-Christ|2021-4-9\s?(.*))$/)
        expect(s1.getLocaleDateElement('era', 'short', locale2)).toMatch(/^(4\s9,\s2021\sAD|9\s4\s2021\sap\.\sJ\.-C\.|2021-4-9\s?(.*))$/)
        expect(s1.getLocaleDateElement('era', 'narrow', locale2)).toMatch(/^(4\s9,\s2021\sA|9\s4\s2021\sap\.\sJ\.-C\.|2021-4-9\s?(.*))$/)
        // locale3
        if (s1.getLocaleDateElement('year', 'numeric', locale3) !== 'NaN') {
            expect(s1.getLocaleDateElement('year', 'numeric', locale3)).toBe(2021)
            expect(s1.getLocaleDateElement('year', '2-digit', locale3)).toBe('21')
            expect(s2.getLocaleDateElement('month', 'long', locale3)).toMatch(/^(M05|May|mai)$/)
            expect(s2.getLocaleDateElement('month', 'short', locale3)).toMatch(/^(M05|May|mai)$/)
            ...
            expect(s1.getLocaleDateElement('weekday', 'long', locale3)).toMatch(/^(Fri(|day)|vendredi)$/)
